            ...
            <div class="card-box">
                    ...
                    <div class="col-md-6 border p-0">
                        ...
                        <div class="row pl-2 pt-1">
                            <div class="col-12 d-flex justiy-content-start">
                                <label>Name:</label>
                                <span class="ml-1">Foysal</span>
                            </div>
                        </div>
                        <div class="row pl-2">
                            <div class="col-12 d-flex justiy-content-start">
                                <label>Phone:</label>
                                <span class="ml-1">01675675467</span>
                            </div>
                        </div>
                        <div class="row pl-2">
                            <div class="col-12 d-flex justiy-content-start">
                                <label>Address:</label>
                                <span class="ml-1">Bangladesh</span>
                            </div>
                        </div>
                ...
                <div class="row border">
                    ...
                    <div class="col-sm-3 col-lg-3 mt-1">
                        <ul class="list-unstyled">
                            ...
                            <li><b>Net Amount :</b><span class="float-right"><i class="fas fa-dollar-sign"></i></span></li>
                          
                            <li><b>Total :</b><span class="float-right"><i class="fas fa-rupee-sign"></i> </span></li>
                            <li><b>CGST :</b><span class="float-right"><i class="fas fa-rupee-sign"></i> </span></li>
                            <li><b>SGST :</b><span class="float-right"><i class="fas fa-rupee-sign"></i></span></li>
                            <li><b>IGST :</b><span class="float-right"><i class="fas fa-rupee-sign"></i> </span></li>
                            <li><b>Total Tax :</b><span class="float-right"><i class="fas fa-rupee-sign"></i> </span></li>
                            <li><b>Net Amount :</b><span class="float-right"><i class="fas fa-rupee-sign"></i></span></li>
                ...
                <div class="mt-4 mb-1">
                    <div class="text-right d-print-none">
                        ...
                        <a href="{{ route('gst.index') }}" class="btn btn-danger waves-effect waves-light">All
