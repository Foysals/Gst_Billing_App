        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ route('gst.create') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" required value="" name="invoice_no" class="form-control border-bottom" id="validationCustom02" placeholder="Enter Invoice number">
                                </div>
                            </div>
                        </div>
