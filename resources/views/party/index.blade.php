                            ...
                            <td>
                                <div class="btn-group dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        @endif
                                        <a class="dropdown-item" href="{{route('party.edit',$party->id)}}"><i class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Edit</a>
                                        <a class="dropdown-item" href="{{route('party.delete',$party->id)}}"><i class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i>Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
